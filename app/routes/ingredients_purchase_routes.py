...
bp_ipurchase.post("/purchases/<int:id>")(ingredients_purchase_controller.ingredients_purchase_creator)
bp_ipurchase.get("/ingredients_purchase")(ingredients_purchase_controller.ingredients_purchase_loader)
